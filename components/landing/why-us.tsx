          ...
          {t.whyUs.cards.map((card, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute -inset-px rounded-2xl bg-linear-to-br ${gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-[1px]`}
                />

                <div className="relative bg-white rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-xl transition-all duration-300 h-full">
                  <div
                    className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br ${gradient} mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300`}
                  >
