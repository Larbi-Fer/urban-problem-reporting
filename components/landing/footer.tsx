        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#007A33]/20 hover:border-[#007A33]/30 transition-all duration-300"
                  >
                    <Icon size={18} />
                  </a>
                );
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-sm text-gray-400 hover:text-[#00A651] transition-colors duration-200"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          >
            <h3 className="font-semibold text-lg mb-4">
              {language === "ar" ? "التحميل" : "Téléchargement"}
            </h3>
            <a
              href="#download-app"
